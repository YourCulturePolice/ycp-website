  ...
  return (
    <div className="min-h-screen bg-black text-white py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <p className="text-zinc-400 text-center mb-16">Last updated: Jan 29, 2025</p>

        <div className="space-y-6 text-zinc-300">
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">OVERVIEW</h2>
          <p>
            This website is operated by Your Culture Police. Throughout the site, the terms "we", "us" and "our" refer
            to Your Culture Police. Your Culture Police offers this website, including all information, tools and
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 1 - ONLINE STORE TERMS</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 2 - GENERAL CONDITIONS</h2>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 7 - OPTIONAL TOOLS</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 8 - THIRD-PARTY LINKS</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 10 - PERSONAL INFORMATION</h2>
          <p>
            Your submission of personal information through the store is governed by our Privacy Policy. To view our
            Privacy Policy.
          </p>

          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 12 - PROHIBITED USES</h2>
          <p>
          ...
          <p>
            In no case shall Your Culture Police, our directors, officers, employees, affiliates, agents, contractors,
            ...
            of the service or any products procured using the service, or for any other claim related in any way to your
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 14 - INDEMNIFICATION</h2>
          <p>
            You agree to indemnify, defend and hold harmless Your Culture Police and our parent, subsidiaries,
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 15 - SEVERABILITY</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 16 - TERMINATION</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 17 - ENTIRE AGREEMENT</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 18 - GOVERNING LAW</h2>
          <p>
            These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and
            construed in accordance with the laws of India.
          </p>

          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 19 - CHANGES TO TERMS OF SERVICE</h2>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">SECTION 20 - CONTACT INFORMATION</h2>
          <p>Questions about the Terms of Service should be sent to us at hello@yourculturepolice.com</p>
        </div>
      </div>
    </div>
  )
