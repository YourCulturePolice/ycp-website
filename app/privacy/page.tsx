      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="space-y-6 text-zinc-300">
          ...
          <ul className="list-disc ml-6 mt-2 space-y-2">
            ...
            <li>
              <strong>Website</strong> refers to Your Culture Police, accessible from www.yourculturepolice.com
            </li>
            <li>
          ...
          <h3 className="text-xl font-semibold text-white mb-2">Tracking Technologies and Cookies</h3>
          <p>
          ...
          <p>
            ...
            You can learn more about cookies on this TermsFeed website article.
          </p>
          ...
          <h3 className="text-xl font-semibold text-white mb-2">Business Transactions</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-white mb-2">Law enforcement</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-white mb-2">Other legal requirements</h3>
          ...
          <ul className="list-disc ml-6 mt-2 space-y-2">
            <li>By email: hello@yourculturepolice.com</li>
          </ul>
        </div>
      </div>
    </div>
